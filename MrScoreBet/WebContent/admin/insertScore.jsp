...
<%@page import="dao.SchedinaDAO"%>
<%@page import="model.*"%>
<%
	Bet toUpdateBet = (Bet) session.getAttribute("toUpdateScore");
%>
...
<head>
	...
	function Modulo() {
		if (!(document.getElementById("match1_1").checked) && !(document.getElementById("match1_X").checked) && !(document.getElementById("match1_2").checked)) {
			alert("Inserisci un pronostico per <%=toUpdateBet.getGameList().get(0).getSquadre()%>!"); return false; }
			...
			alert("Inserisci un pronostico per <%=toUpdateBet.getGameList().get(1).getSquadre()%>!"); return false; }
			...
			alert("Inserisci un pronostico per <%=toUpdateBet.getGameList().get(2).getSquadre()%>!"); return false; }
			...
			alert("Inserisci un pronostico per <%=toUpdateBet.getGameList().get(3).getSquadre()%>!"); return false; }
			...
			alert("Inserisci un pronostico per <%=toUpdateBet.getGameList().get(4).getSquadre()%>!"); return false; }
			...
			alert("Inserisci un pronostico per <%=toUpdateBet.getGameList().get(5).getSquadre()%>!"); return false; }
			...
			alert("Inserisci un pronostico per <%=toUpdateBet.getGameList().get(6).getSquadre()%>!"); return false; }
			...
			alert("Inserisci un pronostico per <%=toUpdateBet.getGameList().get(7).getSquadre()%>!"); return false; }
			...
			alert("Inserisci un pronostico per <%=toUpdateBet.getGameList().get(8).getSquadre()%>!"); return false; }
			...
			alert("Inserisci un pronostico per <%=toUpdateBet.getGameList().get(9).getSquadre()%>!"); return false; }
		//INVIA IL MODULO
		else {
...
<body>
	...
	<article class="panel">
		<div class="panel__copy">
			<h2 align="center">Serie A giornata <%=toUpdateBet.getNumGiornata()%></h2>

			<form class="boxed" id="form1" method="post">
				
				<input type="text" name="post_type" value="insertScore" style="display:none"/>
				...
				<div class="mrw-table mrw-grid">
				    ...
				    <div class="mrw-tr">
				        <div class="mrw-td mrw-width-50 mrw-center"><%=toUpdateBet.getGameList().get(0).getSquadre()%></div>
				    ...
				    <div class="mrw-tr">
				        <div class="mrw-td mrw-width-50 mrw-center"><%=toUpdateBet.getGameList().get(1).getSquadre()%></div>
				        <div class="mrw-td mrw-width-50 mrw-center">
				    ...
				    <div class="mrw-tr">
				        <div class="mrw-td mrw-width-50 mrw-center"><%=toUpdateBet.getGameList().get(2).getSquadre()%></div>
				        <div class="mrw-td mrw-width-50 mrw-center">
				    ...
				    <div class="mrw-tr">
				        <div class="mrw-td mrw-width-50 mrw-center"><%=toUpdateBet.getGameList().get(3).getSquadre()%></div>
				        <div class="mrw-td mrw-width-50 mrw-center">
				    ...
				    <div class="mrw-tr">
				        <div class="mrw-td mrw-width-50 mrw-center"><%=toUpdateBet.getGameList().get(4).getSquadre()%></div>
				        <div class="mrw-td mrw-width-50 mrw-center">
				    ...
				    <div class="mrw-tr">
				        <div class="mrw-td mrw-width-50 mrw-center"><%=toUpdateBet.getGameList().get(5).getSquadre()%></div>
				        <div class="mrw-td mrw-width-50 mrw-center">
				    ...
				    <div class="mrw-tr">
				        <div class="mrw-td mrw-width-50 mrw-center"><%=toUpdateBet.getGameList().get(6).getSquadre()%></div>
				        <div class="mrw-td mrw-width-50 mrw-center">
				    ...
				    <div class="mrw-tr">
				        <div class="mrw-td mrw-width-50 mrw-center"><%=toUpdateBet.getGameList().get(7).getSquadre()%></div>
				        <div class="mrw-td mrw-width-50 mrw-center">
				    ...
				    <div class="mrw-tr">
				        <div class="mrw-td mrw-width-50 mrw-center"><%=toUpdateBet.getGameList().get(8).getSquadre()%></div>
				        <div class="mrw-td mrw-width-50 mrw-center">
				    ...
				    <div class="mrw-tr">
				        <div class="mrw-td mrw-width-50 mrw-center"><%=toUpdateBet.getGameList().get(9).getSquadre()%></div>
				        <div class="mrw-td mrw-width-50 mrw-center">
